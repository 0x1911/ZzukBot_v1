...
namespace OrionHunter
{
    ...
    public class Core : CustomClass
    {
        ...
        public override void Fight()
        {
            try
            {
                ...
                if (!this.HandledMultiTargetCombat())
                {
                    return;
                }
        ...
        public override bool Buff()
        {
            try
            {
                //nothing to do here below level 10
                if(BMain.Me.Level < 10) { return true; }
        ...
        private void CheckForLastResorts()
        {
            if (this.Player.ToCloseForRanged)
            {
                ...
                if (!this.HasSpellByname("Serpent Sting") || !this.Player.Backup(14))
                {
        ...
        private bool TakeCareOfOurPet()
        {
            try
            {
                ...
                if (mendPet.IsWanted && this.CanCast(mendPet) && Attackers.Count <= 1)
                {
                    this.Cast(mendPet);
                    return true;
                }
    ...
    internal class Spellbook
    {
        ...
        public static readonly Spell MultiShot = new Spell("Multi Shot", 950, false, true, isChanneled: false, isInstant: true,
            isWanted:
                () => Me.ManaPercent > 30 && !Me.ToCloseForRanged && Attackers.Count > 1 &&
                    Me.CanUse("Multi Shot"));
        ...
        public static readonly Spell BloodFury = new Spell("Blood Fury", 950, false, true, isChanneled: false, isInstant: true,
            isWanted:
                () => !Me.GotBuff("Blood Fury") &&
                    Me.CanUse("Blood Fury"));

        public static readonly Spell Berserking = new Spell("Berserking", 950, false, true, isChanneled: false, isInstant: true,
            isWanted:
                () => !Me.GotBuff("Berserking") &&
                    Me.CanUse("Berserking"));

        public static readonly Spell RapidFire = new Spell("Rapid Fire", 950, false, true, isChanneled: false, isInstant: true,
            isWanted:
                () => !Me.GotBuff("Berserking") && !Me.GotBuff("Rapid Fire") &&
                    Me.CanUse("Rapid Fire"));
        ...
        private static IReadOnlyList<_Unit> Attackers
        {
            get { return customClassInstance.Value.Attackers; }
        } 
    }
